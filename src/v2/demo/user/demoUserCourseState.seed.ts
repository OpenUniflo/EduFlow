...
export function demoUserCourseStateSeed(userId: string, courseId: string): UserCourseState {
  if (courseId === "agentic-ai") {
    return {
      ...
      materialStates: {
        "lesson-04": { materialId: "lesson-04", recentSegmentId: "page-12", progress: 36, completedSegmentIds: Array.from({ length: 11 }, (_, index) => `page-${String(index + 1).padStart(2, "0")}`), updatedAt: DEMO_TIME }
      },
      recentLessonId: "L04",
      updatedAt: DEMO_TIME
    };
  ...
  if (courseId === "python-engineering") {
    ...
    return {
      ...
      materialStates: {
        "python-core-handbook": { materialId: "python-core-handbook", recentSegmentId: "core-module", progress: 60, completedSegmentIds: ["core-control", "core-scope"], updatedAt: "2026-08-08T08:00:00.000Z" },
        "python-async-service-guide": { materialId: "python-async-service-guide", recentSegmentId: "async-event-loop", progress: 10, completedSegmentIds: [], updatedAt: "2026-08-07T08:00:00.000Z" }
      },
