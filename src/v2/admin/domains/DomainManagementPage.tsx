...
export function DomainManagementPage({ session, onLogout }: { session: MockSession; onLogout: () => void }) {
  ...
  function moveSelected() {
    ...
    assignNodesToDomain({ actor, nodeIds: selectedNodeIds, domainId: moveTarget });
  ...
  function createNewDomain() {
    ...
    const created = createDomain({ actor, name: newName.trim(), description: "管理员创建的知识领域。", scope: "global" });
