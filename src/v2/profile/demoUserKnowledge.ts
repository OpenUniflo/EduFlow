...
const demoUserNode: KnowledgeNode = {
  ...
  ownerId: "demo-user",
  domainId: "agentic-ai",
  clusterId: "agentic-capabilities",
...
function courseEvidence(nodeId: string, lesson: number) {
...
export const demoUserKnowledge: UserKnowledgeRecord[] = [
  ...
  { nodeId: "PY53", status: "mastered", mastery: 82, masteryOrigin: "direct", updatedAt: "2026-06-19T08:00:00.000Z" },
  ...
  { nodeId: "PY61", status: "learning", mastery: 46, masteryOrigin: "direct", updatedAt: "2026-07-20T08:00:00.000Z" },
  { nodeId: "PY62", status: "learning", mastery: 34, masteryOrigin: "direct", updatedAt: "2026-07-24T08:00:00.000Z" },
  { nodeId: "AG01", status: "mastered", mastery: 100, masteryOrigin: "direct", updatedAt: "2026-07-01T08:00:00.000Z", evidence: courseEvidence("AG01", 1) },
  ...
  { nodeId: "A02", status: "mastered", mastery: 100, masteryOrigin: "direct", updatedAt: "2026-07-08T08:00:00.000Z", evidence: courseEvidence("A02", 3) },
  ...
  { nodeId: "R04", status: "learning", mastery: 55, masteryOrigin: "direct", updatedAt: "2026-07-28T08:00:00.000Z", evidence: courseEvidence("R04", 4) },
  { nodeId: "R06", status: "learning", mastery: 58, masteryOrigin: "direct", updatedAt: "2026-07-30T08:00:00.000Z", evidence: courseEvidence("R06", 4) }
];
