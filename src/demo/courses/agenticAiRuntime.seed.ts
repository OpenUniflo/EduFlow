...
export const agenticAiNativeMaterials: Material[] = [
  { id: "native-parallel-merge", courseId: COURSE_ID, order: 1, title: "并行执行与结果汇合", description: "AI Native Lesson · 从串行检索重构为并行研究工作流", type: "article", duration: "35 分钟", segments: [
  ...
  { id: "native-failure-verification", courseId: COURSE_ID, order: 2, title: "故障、验证与终止", description: "AI Native Lesson · 正确处理 Worker timeout、验证与取消", type: "article", duration: "40 分钟", segments: [
