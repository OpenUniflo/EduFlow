...
const runtime = (courseId: string, lifecycle: CourseLifecycle = "published", assignmentCount = 1): CourseRuntimeData => ({
  ...
  materials: [{ id: `material-${courseId}`, courseId, order: 1, title: "Material", type: "article", segments: [{ id: "segment", order: 1, title: "Segment" }] }], materialKnowledgeCoverages: [{ id: `material-coverage-${courseId}`, materialId: `material-${courseId}`, segmentId: "segment", nodeId: "knowledge", role: "introduce" }], revision: "1"
});
