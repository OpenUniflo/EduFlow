...
export type GenerationStage = "course-intent" | "goal-resolution" | "extraction" | "deduplication" | "coverage" | "admission" | "relations" | "curriculum" | "implementation-steps" | "assignments" | "assignment-dependencies";
