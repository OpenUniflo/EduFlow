  ...
  return (
    <main className="atlas-page-shell atlas-course-center">
      ...
      <div className="atlas-content-wrap">
        <section className="atlas-course-title atlas-course-title-row"><div><h1>课程中心</h1><p>{session ? "标准课程与仅你可见的个人课程共用同一 Course 体系；我的课程只包含你主动选择或开始的课程。" : "无需登录即可浏览 Published 标准课程；个人课程、进度与 My Courses 会在登录后显示。"}</p></div><span className="atlas-pill">{courses.length} 门可见课程{session ? ` · ${learningCount} 门我的课程` : ""}</span></section>
