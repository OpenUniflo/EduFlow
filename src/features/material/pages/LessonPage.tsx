...
function MaterialReaderShell({ runtime, material, userState, savedState, session, lessonAssistantProvider, onLogout, draftState }: {
  ...
  const assistantContext = {workspace:"material" as const,experienceMode:experience,userRole:session.role,capabilities:session.capabilities,courseId:runtime.course.id,lessonId:lesson?.id,materialId:material.id,segmentId:reader.activeSegmentId,knowledgeId:effectiveKnowledgeId??undefined,assignmentId:activeAssignmentId??undefined};
