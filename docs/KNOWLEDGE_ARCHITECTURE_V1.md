...
ELK is the sole production owner of course layer assignment, compound group sizing, ports, coordinates, crossing minimization, and orthogonal edge routing. The Force Graph engine is the sole production owner of Atlas force coordinates. Legacy handcrafted layout and routing helpers may remain for tests or migration comparison but must not participate in these production render paths.
