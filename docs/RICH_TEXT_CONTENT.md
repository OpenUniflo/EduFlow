...
The teaching contract is [Observable Learner Action](TEACHING_PATTERN_LIBRARY.md#observable-learner-action-rule). Content audit is semantic review of action versus captured input, not a global keyword validator. No Publish Validator, authoring editor, new interaction runtime, grading authority or learner-state changes are included.
