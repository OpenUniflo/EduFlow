...
Micro completion context projects real Course Material/Segment and Assignment coverage plus Navigation next Knowledge. Course is optional context for the one Micro Experience; missing context produces no empty capability cards. Practice does not block the current instructional route. Completion = learned, not mastery; Course progress percentages and stronger mastery policy are unchanged.
